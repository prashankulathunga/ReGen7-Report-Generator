...
import { a as EMPTY_ARRAY, i as useRefWithInit, o as EMPTY_OBJECT, r as useMergedRefs, t as useRenderElement } from "./useRenderElement-vh9WRPLS.js";
import { a as fieldValidityMapping, i as useFieldRootContext, n as useFormContext, o as useControlled, r as useRegisterFieldControl, t as useLabelableContext } from "./LabelableContext-1isqE0j2.js";
import { S as useIsoLayoutEffect, d as getWindow, m as isHTMLElement, t as useStableCallback } from "./useStableCallback-t0RcF5LA.js";
import { a as transitionStatusMapping, c as useAnimationFrame, d as visuallyHiddenInput, n as useOpenChangeComplete, t as useTransitionStatus, u as visuallyHidden } from "./useTransitionStatus-Df7vyjD_.js";
import { c as itemPress, g as useBaseUiId, h as windowResize, l as listNavigation, n as cancelOpen, o as focusOut, t as createChangeEventDetails, u as none, v as ownerDocument } from "./createBaseUIEventDetails-DybhBfKv.js";
import { r as mergeProps } from "./merge-props-B1zstas5.js";
import { t as useButton } from "./useButton-CGWALT1K.js";
import { t as useValueChanged } from "./useValueChanged-B4c2l1ie.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { A as DROPDOWN_COLLISION_AVOIDANCE, At as stopEvent, Bt as pressableTriggerOpenStateMapping, C as useFloatingParentNodeId, Ct as ARROW_DOWN, Et as ARROW_UP, G as isIndexOutOfListBounds, H as getMaxListIndex, It as useTimeout, K as isListIndexDisabled, Mt as webkit, Ot as isVirtualClick, S as useDismiss, T as FloatingPortal, Tt as ARROW_RIGHT, U as getMinListIndex, V as findNonDisabledListIndex, Vt as triggerOpenStateMapping, W as isElementVisible, _ as useStore, _t as getFloatingFocusElement, b as createSelector, bt as isTypeableCombobox, g as Store, gt as addEventListener, jt as jsdom, kt as isVirtualPointerEvent, mt as useValueAsRef, r as FOCUSABLE_POPUP_PROPS, t as inertValue, ut as rectToClientRect, w as useFloatingTree, wt as ARROW_LEFT, x as useOnFirstRender, zt as popupStateMapping } from "./inertValue-D7TuKpVD.js";
import { n as contains, r as getTarget, t as activeElement } from "./shadowDom-DBsqwHc4.js";
import { a as COMPOSITE_KEYS, c as enqueueFocus, i as InternalBackdrop, o as useClick, r as useScrollLock, s as FloatingFocusManager, t as useOpenInteractionType } from "./useOpenInteractionType-Wuu6HNP5.js";
import { a as useDirection, c as platform, n as getDisabledMountTransitionStyles, o as usePreviousValue, r as useAnchorPositioning, s as useFloatingRootContext, t as usePositioner } from "./usePositioner-D7o0oKBC.js";
import { t as useLabelableId } from "./useLabelableId-DpDysTFW.js";
import { t as Separator } from "./Separator-BSAWgv0M.js";
